...
<div class="container text-justify">
		<div class="row mt-5">
			...
			<div class="col-md-11">
				...
				<p><strong>Platón</strong>, responsable del sitio web, en adelante RESPONSABLE, pone a disposición de los usuarios el presente documento, con el que pretende dar cumplimiento a las obligaciones dispuestas en la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico (LSSICE), así como informar a todos los usuarios del sitio web respecto a cuáles son las condiciones de uso.</p>
				<p>Toda persona que acceda a este sitio web asume el papel de usuario, comprometiéndose a la observancia y cumplimiento riguroso de las disposiciones aquí dispuestas, así como a cualquier otra disposición legal que fuera de aplicación.&nbsp;</p>
				<p> <strong>Platón</strong> se reserva el derecho de modificar cualquier tipo de información que pudiera aparecer en el sitio web, sin que exista obligación de preavisar o poner en conocimiento de los usuarios dichas obligaciones, entendiéndose como suficiente con la publicación en el sitio web de <strong>Platón</strong></p>
				<p><strong>1. DATOS IDENTIFICATIVOS</strong></p>
				<p>Denominación social: <strong>Platón</strong> <br>Nombre comercial: <strong>Platón</strong><br>CIF: <strong>NUMERO CIF</strong><br>Domicilio: <strong>DIRECCION DE TU NEGOCIO</strong> <br>e-mail: <strong>tuemail@tudominio. com</strong></p>
				...
				<p>Las cookies recopilan la dirección<span class="has-inline-color has-black-color"> <a class="rank-math-link" href="https://ceporros.com">IP</a> </span>del usuario siendo <a href="https://presencialismo.com" class="rank-math-link" target="_blank" rel="noopener"><span class="has-inline-color has-black-color">Google</span></a> el responsable del tratamiento de esta información.</p>
